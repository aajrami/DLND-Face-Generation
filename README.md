...
In this project we built a model using Generative Adversarial Networks (GANs) to generate new face images. The [_**CelebFaces Attributes Dataset (CelebA)**_](http://mmlab.ie.cuhk.edu.hk/projects/CelebA.html) was used to train the model.
